    ...
    <!-- header -->
      ...
      <div class="container-fluid">
        ...
        <ul class="nav nav-tabs nav-justified">
          <li role="presentation"><a data-target="#sidebar" data-toggle="collapse" aria-expanded="false" aria-controls="collapseExample0">PHP basics</a></li>
          <li role="presentation"><a data-target="#sql" data-toggle="collapse" aria-expanded="false" aria-controls="collapseExample0.01">SQL basics</a></li>
        </ul>
        <!-- nav ends-->
        <div class="row">
          <div class="col-md-1"></div>
          <div class="col-md-2">
            <div class="collapse" id="sql">
              <ul class="nav nav-tabs nav-stacked">
                <li role="presentation"><a href="#">Page Yet To Arrive</a></li>
              </ul>
            </div>
